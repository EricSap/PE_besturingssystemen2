...
declare class Transfer extends React.Component<TransferProps, any> {
    ...
    static Operation: ({ disabled, moveToLeft, moveToRight, leftArrowText, rightArrowText, leftActive, rightActive, className, style, }: import("antd/lib/transfer/operation").TransferOperationProps) => JSX.Element;
    ...
    handleSelectAll: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, filteredDataSource: TransferItem[], checkAll: boolean) => void;
    ...
    handleSelect: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, selectedItem: TransferItem, checked: boolean) => void;
    ...
    handleScroll: (direction: import("antd/lib/collapse/Collapse").ExpandIconPosition, e: React.SyntheticEvent<HTMLDivElement, Event>) => void;
    ...
    handleListStyle: (listStyle: (style: ListStyle) => React.CSSProperties, direction: import("antd/lib/collapse/Collapse").ExpandIconPosition) => React.CSSProperties;
    separateDataSource(): {
        leftDataSource: TransferItem[];
        rightDataSource: TransferItem[];
    };
