...
var debugMessage      = require('adjust-sourcemap-loader/lib/process/debug-message'),
    toRegExp          = require('adjust-sourcemap-loader/lib/process/to-reg-exp'),
    throwErrors       = require('adjust-sourcemap-loader/lib/process/throw-errors'),
    decodeSourcesWith = require('adjust-sourcemap-loader/lib/process/decode-sources-with'),
    locateRootWith    = require('adjust-sourcemap-loader/lib/process/locate-root-with'),
    encodeSourcesWith = require('adjust-sourcemap-loader/lib/process/encode-sources-with'),
    testCodec         = require('adjust-sourcemap-loader/lib/process/test-codec');

var CODECS = require('adjust-sourcemap-loader/codec');
