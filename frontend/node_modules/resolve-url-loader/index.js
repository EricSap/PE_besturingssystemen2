...
var joinFn           = require('resolve-url-loader/lib/join-function');
var logToTestHarness = require('resolve-url-loader/lib/log-to-test-harness');

var PACKAGE_NAME = require('resolve-url-loader/package.json').name;
